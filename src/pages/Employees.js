      ...
      <div>
        ...
        <Container style={{ marginTop: 30 }}>
          ...
          <Row>
            <Col size="md-12">
              <p>
                UFR is a small table with a dash of functionality that allows you to view non-personal data of your current employees. The table columns can be sorted by ascending or descending order. To filter, simply type into the desired column you wish to filter. It will instantly update with the results.
              </p>
